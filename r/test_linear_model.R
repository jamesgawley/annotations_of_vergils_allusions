...
# the various functions are used to test model efficacy
# example usage: test.slice(data, .8)
require(MASS)
...
test.slice <- function (data, i = .8, even = FALSE) {
  ...
  plot(rounded.results, type = 'l', ylim = c(-4, 4), ylab = "Human Ranking Minus Rounded Prediction", xlab = "Index # of Parallel")
